...
namespace PhotoLife.Services.Tests.PostsServiceTests
{
    ...
    public class GetTopByComments_Should
    {
        ...
        public void _Call_PostRepository_GetAll(int topCount)
        {
            ...
            //Act
            postService.GetTopByComments(topCount);
        ...
        public void _Return_Correct_Collection(int topCount)
        {
            ...
            var expectedCollection = mockedPostCollection.OrderBy(m => m.Comments.Count).Take(topCount).ToList();
            ...
            //Act
            var collectionRes = postService.GetTopByComments(topCount);
