...
{
    [TestFixture]
    public class AddCommentToPostShould
    {
        [TestCase("Coment text", 1, "user id")]
        [TestCase("Coment texasdasdt", 5, "userId&8")]
        public void _Call_DateTimeProvider_GetCurrentDate(string text, int postId, string userId)
        {
            //Arrange
        ...
        [TestCase("Coment text", 1, "user id")]
        [TestCase("Coment texasdasdt", 5, "userId&8")]
        public void _Call_CommentFactory_CreateComment(string text, int postId, string userId)
        {
            //Arrange
            var user = new User();
